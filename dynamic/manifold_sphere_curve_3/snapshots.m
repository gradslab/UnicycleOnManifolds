function snapshots(x, T, r,a,b,c, tShow)
...
ax.FontSize = 12;
% ---- Draw surface ----
x1g = linspace(- 2.5*r, 2.5*r, 250);
x2g = linspace(- 2.5*r, 2.5*r, 250);
...
p=plot3(ax, xc, yc, zc, '-','color',[110, 173, 33]/255, 'LineWidth', 1.5);
lgd = legend(p,'Curve on $\mathsf{M}$','Location','north');
