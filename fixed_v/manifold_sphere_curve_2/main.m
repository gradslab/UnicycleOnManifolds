...
tic;
    [T,Z]=ode89(@(t,z)geo_unicycle(t, z, r),t,IC);
toc;


%% Fetching data
for i = 1 :length(T)
    [~,phi__2(i,1),phi__2_dot(i,1), const_1(i,1),const_2(i,1),ch(i,1),ch_dt(i,1)] = geo_unicycle(T(i),Z(i,:),r);
end
%% Plot
...
% animate([Z(:,1).'; Z(:,2).'; Z(:,3).'], T, r, 'false', true, 'Filename', 'unicyle_on_manifold.mp4')
snapshots([Z(:,1).'; Z(:,2).'; Z(:,3).'], T, r, [0 1 2 4 5 6 7 8 9 10])